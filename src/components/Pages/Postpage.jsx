...
const PostPage = ({ setPage }) => {
    ...
    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <Link className="w-full bg-blue-500 text-white p-2 rounded" to={'/timeline'}>Post</Link>
        <Link className="w-full bg-gray-500 text-white p-2 rounded mt-2" to={'/timeline'}>Cancel</Link>
            </div>
        </div>
    );
};
